...
public class RelationRepositoryTest {
	...
	public void testGetRelationsById() {
		...
		List<RelationEntity> relationList = relationRepository.findAllByUserFkIdOwnerRelation(secondId);
        assertTrue(relationList.size() > 0);
        assertEquals(secondId,relationList.get(0).getUserFkIdOwnerRelation());
